...
import { fetchPersonCredits, fetchPersonDetail, image342 } from "../api/moviedb";
...
export default function PersonScreen() {
  ...
  useEffect(()=>{
    setLoading(true);
    getPersonDetails(items.id);
    getPersonMovies(items.id);
  },[items]);
    ...
    >
      ...
      {loading ? (
        ...
        <View>
          ...
          >
            <View className="items-center rounded-full overflow-hidden h-72 w-72 border-2 border-r-neutral-500">
              <Image
